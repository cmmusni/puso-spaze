...
**Read [references/constitution.md](./references/constitution.md)** for the full template and examples.
...
**This is the most important deliverable.** Read [references/functional_tests.md](./references/functional_tests.md) for the complete guide.
...
**Read [references/review_protocols.md](./references/review_protocols.md)** for the template.
...
**Read [references/spec_audit.md](./references/spec_audit.md)** for the full protocol.
...
Before declaring done, check every benchmark. **Read [references/verification.md](./references/verification.md)** for the complete checklist.
...
|------|-------------|----------|
| [references/defensive_patterns.md](./references/defensive_patterns.md) | Step 5 (finding skeletons) | Grep patterns, how to convert findings to scenarios |
| [references/schema_mapping.md](./references/schema_mapping.md) | Step 5b (schema types) | Field mapping format, mutation validity rules |
| [references/constitution.md](./references/constitution.md) | File 1 (QUALITY.md) | Full template with section-by-section guidance |
| [references/functional_tests.md](./references/functional_tests.md) | File 2 (functional tests) | Test structure, anti-patterns, cross-variant strategy |
| [references/review_protocols.md](./references/review_protocols.md) | Files 3–4 (code review, integration) | Templates for both protocols |
| [references/spec_audit.md](./references/spec_audit.md) | File 5 (Council of Three) | Full audit protocol, triage process, fix execution |
| [references/verification.md](./references/verification.md) | Phase 3 (verify) | Complete self-check checklist with all 13 benchmarks |
