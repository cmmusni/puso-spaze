...
tools: [read, edit, search, execute, agent, web, todo, memory, read/viewImage, write/createFile, write/updateFile, write/deleteFile, install dependencies, gitkraken/git_add_or_commit, gitkraken/git_push, gitkraken/git_pull, gitkraken/git_checkout, gitkraken/git_branch, gitkraken/git_merge]
---
